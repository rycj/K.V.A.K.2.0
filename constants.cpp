...
void Constants::updateUIConstants()
{
    ...
    tabList = {"N body problem", "SIMPLE", "ODR", "4", "5"};
    NBodySettingsSize = ImVec2(mainWindowSize.x / 5, mainWindowSize.y);
    NBodyPlotSize=ImVec2(mainWindowSize.x *4/ 5, mainWindowSize.y*18/20);
    FullPlotSize=ImVec2(mainWindowSize.x *4/ 5, mainWindowSize.y*19/20);
